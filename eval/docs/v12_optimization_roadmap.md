...
**诚实排名(`eval/novelty_rerank.py`,在 real vs【新颖子集】上重算鉴别器;标定 C2ST 0.495 / SigP 0.326):**

| | 复制率 | C2ST_all | **C2ST_新颖** | SigP_all | **SigP_新颖** |
|---|---|---|---|---|---|
| v11 | 48.5% | 0.769 | 0.798 | 0.003 | 0.090 |
| v10_retrained | 53.9% | 0.750 | **0.821** | 0.395 | **0.585** |
| v10_sampling | 41.9% | 0.874 | 0.896 | 0.003 | 0.003 |
| v9 | 30.1% | 0.867 | 0.904 | 0.003 | 0.003 |

所有模型 **C2ST_新颖 > C2ST_all**(真实感被复制撑起);**新颖子集均强可检出(0.80–0.90 vs 标定 0.495)= 无模型能生成令人信服的新颖数据**。v10_retrained 新颖样本签名上不可分(SigP 0.585)但 stylized 上仍可分(C2ST 0.821);v11 反之。**v12 go/no-go 北极星 = C2ST_新颖 / SigP_新颖 + 复制率**,不再看 all 口径。
